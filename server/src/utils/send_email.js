...
const sendEmail = async (email, otp, type = "signup") => {
  ...
  const emailContent = {
    signup: {
      subject: "Welcome to Event-Connect - Verify Your Email ✨",
      title: "Welcome to Event-Connect!",
      greeting: "Hi there,",
      message:
        "Thank you for joining Event-Connect! We're excited to have you on board. Use the following OTP to verify your email and complete your registration.",
      actionText: "This OTP is valid for 5 minutes.",
      footer: "If you didn't create an account, please ignore this email.",
    },
    reset: {
      subject: "Event-Connect - Password Reset Request 🔐",
      title: "Reset Your Password",
      greeting: "Hello,",
      message:
        "We received a request to reset your password for your Event-Connect account. Use the following OTP to proceed with resetting your password.",
                ...
                <td style="padding: 40px 30px;">
                  ...
                  <div style="background: #f8f9fa; border-left: 4px solid #667eea; padding: 15px 20px; border-radius: 4px; margin: 30px 0;">
                    <p style="margin: 0; color: #666666; font-size: 13px; line-height: 1.6;">
                      <strong style="color: #333333;">Security Tip:</strong> Never share this OTP with anyone. Event-Connect will never ask for your OTP via phone or email.
                    </p>
                  </div>
              ...
              <tr>
                <td style="background: #f8f9fa; padding: 30px; text-align: center; border-top: 1px solid #e9ecef;">
                  ...
                  <p style="margin: 15px 0 0; color: #999999; font-size: 11px;">
                    © 2025 Event-Connect Inc. All rights reserved.
                  </p>
                </td>
              </tr>
  ...
  const info = await transporter.sendMail({
    from: '"Event-Connect" <abrarjahinayat123@gmail.com>',
    to: email,
