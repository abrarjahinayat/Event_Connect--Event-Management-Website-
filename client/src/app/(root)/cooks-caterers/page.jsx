...
export default function ProductionHousesPage() {
  ...
  const translations = {
    en: {
      title: 'All Premium Cooks & Caterers',
      subtitle: 'Professional Cooking & Catering Services',
      description: 'Find top-rated, admin-verified cooks and caterers for your next event',
