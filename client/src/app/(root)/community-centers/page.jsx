...
export default function ProductionHousesPage() {
  ...
  const translations = {
    en: {
      title: 'All Premium Community Centers',
      subtitle: 'Professional Community Center Services',
      description: 'Find top-rated, admin-verified Community Centers for your next event',
