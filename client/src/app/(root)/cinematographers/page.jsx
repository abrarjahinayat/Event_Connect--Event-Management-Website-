...
export default function ProductionHousesPage() {
  ...
  const translations = {
    en: {
      title: 'All Premium Cinematographers',
      subtitle: 'Professional Cinematography Services',
      description: 'Find top-rated, admin-verified Cinematographers for your next project',
  ...
  const fetchServices = async () => {
    try {
      ...
      const queryParams = new URLSearchParams({
        serviceCategory: 'Cinematographers',
  ...
  const handleViewDetails = (identifier) => {
    router.push(`/cinematographers/${identifier}`);
  };
