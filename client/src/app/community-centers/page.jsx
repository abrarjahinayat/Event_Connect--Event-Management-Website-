  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-cyan-50">
      ...
      <div className="bg-cyan-600 text-white py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            Community Centers Services in Bangladesh
          </h1>
          <p className="text-cyan-100 text-lg max-w-2xl">
            Discover and book premium community centers services in Dhaka for your next project.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {/* Community Centers Services Grid */}
        {filteredHouses.length > 0 ? (
          ...
          <div className="bg-white rounded-xl shadow-md p-12 text-center">
            ...
            <p className="text-gray-600 mb-6">
              We couldn't find any community centers services matching your criteria.
            </p>
            <button
              onClick={resetFilters}
