...
// Cooks & Caterers Card Component with Admin Rating
...
export default function ProductionHousesPage() {
  ...
  const handleViewDetails = (identifier) => {
    router.push(`/cooks-caterers/${identifier}`);
  };
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-cyan-50">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading Cooks & Caterers...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="bg-cyan-600 text-white py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            Cooks & Catererss in Bangladesh
          </h1>
          <p className="text-cyan-100 text-lg max-w-2xl">
            Discover and book premium Cooks & Caterers verified by our admin team.
          </p>
        </div>
      </div>
        ...
        {filteredHouses.length > 0 ? (
          ...
          <div className="bg-white rounded-xl shadow-md p-12 text-center">
            ...
            <p className="text-gray-600 mb-6">
              We couldn't find any Cooks & Caterers matching your criteria.
            </p>
            <button
              onClick={resetFilters}
